# Run Mocha Tests in Incognito on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Mocha Tests in Incognito across real browsers and operating systems.
